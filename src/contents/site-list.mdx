...
<DataTb
  path2csv = "../data/borderscape-sites.csv"
  striped
  columns = {
    [
    {
    ...
    {
      name: "Phase 1",
      selector: row => row['Phase 1'],
      sortable: true,
    },
    {
      name: "Phase 2",
      selector: row => row['Phase 2'],
      sortable: true,
    },
    {
      name: "Phase 3",
      selector: row => row['Phase 3'],
      sortable: true,
    },
    {
      name: "Phase 4",
      selector: row => row['Phase 4'],
      sortable: true,
    },
    {
      name: "Phase 5",
      selector: row => row['Phase 5'],
      sortable: true,
    },
    {
      name: "Phase 6",
      selector: row => row['Phase 6'],
      sortable: true,
    },
    {
      name: "C14",
