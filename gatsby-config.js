...
module.exports = {
  ...
  pathPrefix: process.env.NODE_ENV === '/',
  siteMetadata: {
    title: `BORDERSCAPE`,
    ...
    siteUrl: `https://webgis.borderscapeproject.org/`,
  },
  plugins: [
    `gatsby-plugin-image`,
    `gatsby-plugin-mdx`,
    ...
    },
    {
      ...
      options: {
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/borderscape.svg`, // This path is relative to the root of the site.
      },
    },
    {
